...
: ${AMENT_CURRENT_PREFIX:="/var/robotic/yahboomcar_ws/install/arm_kin"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/arm_kin/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/arm_kin/environment/path.sh"
